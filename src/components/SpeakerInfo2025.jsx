...
import speaker2025 from "./Speakrs2025";
import AOS from "aos";

const SpeakersInfo2025 = () => {
  useEffect(() => {
    AOS.init();
  }, []);
  return (
    <>
      ...
      <div className="speakers-2024">
        <div className="text-center lg:text-5xl text-4xl font-inter font-bold lg:p-10 p-5 ">
          SPEAKERS FOR <span className="text-red-500">TEDxJSPMRSCOE-2025</span>
        </div>
        <div className="grid grid-cols-1 grid-rows-6 md:grid-cols-2 md:grid-rows-1 gap-28 p-6">
          {speaker2025?.map((elem, ind) => {
            return (
              <div
                data-aos="zoom-in"
...
export default SpeakersInfo2025;
